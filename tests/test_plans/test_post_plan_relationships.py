"""
Tests for Plans.post_plan_relationships method.
...
class TestPostPlanRelationships:
    """Test suite for post_plan_relationships method"""
    
    def test_post_plan_relationships_success(self, mock_plans_api):
        """Test successful creation of plan relationships"""
        # Mock response data
        mock_response = Mock()
        ...
        # Call the method
        response = mock_plans_api.post_plan_relationships(
    ...
    def test_post_plan_relationships_work_items(self, mock_plans_api):
        """Test adding work items to plan"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_single_item(self, mock_plans_api):
        """Test adding single relationship item"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_multiple_work_items(self, mock_plans_api):
    ...
    def test_post_plan_relationships_project_span(self, mock_plans_api):
        """Test adding project span relationships"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_error_400(self, mock_plans_api):
    ...
    def test_post_plan_relationships_error_401(self, mock_plans_api):
    ...
    def test_post_plan_relationships_url_structure(self, mock_plans_api):
    ...
    def test_post_plan_relationships_different_relationship_types(self, mock_plans_api):
        """Test post_plan_relationships with different relationship IDs"""
    ...
    def test_post_plan_relationships_json_payload_format(self, mock_plans_api):
    ...
    def test_post_plan_relationships_with_revisions(self, mock_plans_api):
        """Test adding relationships with revision information"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_parent(self, mock_plans_api):
    ...
    def test_post_plan_relationships_children(self, mock_plans_api):
        """Test adding children relationships"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_large_batch(self, mock_plans_api):
        """Test adding relationships with large batch of items"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_data_structure(self, mock_plans_api):
    ...
    def test_post_plan_relationships_consistent_type(self, mock_plans_api):
        """Test that all items in relationship have consistent type"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_empty_data(self, mock_plans_api):
        """Test adding empty relationships data"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
    ...
    def test_post_plan_relationships_cross_project_items(self, mock_plans_api):
        """Test adding work items from different projects"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
        ...
        relationships_data = {
            "data": [
                {"type": "workitems", "id": "Project1/WI-1"},
                {"type": "workitems", "id": "Project2/WI-5"},
                {"type": "workitems", "id": "Project3/WI-10"}
            ]
        }
        ...
        sent_data = call_args[1]['json']
        assert len(sent_data['data']) == 3
        assert 'Project1' in sent_data['data'][0]['id']
        assert 'Project2' in sent_data['data'][1]['id']
        assert response.status_code == 200
    
    def test_post_plan_relationships_incremental_add(self, mock_plans_api):
        """Test adding relationships incrementally"""
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {}
